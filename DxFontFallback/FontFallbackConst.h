...
namespace DWriteFontFallback
{
	struct FormatInfo
	{
		wchar_t FontFamilyName[20];
		float   FontSize;
		bool    CustomFallback;
	};
	...
	namespace SampleConstants
	{
		...
		static const TextInfo TextStrings1[] =
		{
			...
			{ FormatBody,       BrushBlack,     false, L"カガキギクグケゲコゴサザ" }, //This is a set of Katakana letters  '
			{ FormatBody,       BrushBlack,     false, L"คุณธรรม, พิศุทธิ์, สวัสดี, ความดี, คุณงามความดี" }, //This is a set of THAI letters  '
			{ FormatBody,       BrushBlack,     false, L"你好親愛的"} // Traditionnal Chinese
			
			
			
		};
		static const unsigned int MaxTextBlocks1 = ARRAYSIZE(TextStrings1);
		...
		static std::wstring FontFallbackDescriptions[] =
		{
			L"System",
			L"Segoe UI Emoji",
